    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('labels', models.ManyToManyField(related_name='labels', to='app.Label', verbose_name='labels')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='status', to='app.status', verbose_name='status')),
            ],
        ),
    ]
